...
const MagazineHero = () => {
	return (
		<section className='min-h-screen bg-slate-100 flex items-center'>
			<div className='max-w-6xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-10 items-center'>
				...
				<div className='flex flex-col gap-6'>
					...
					<p className='text-gray-700 leading-relaxed'>
						Africa’s bustling night markets offer global retail brands
						unique opportunities to connect with consumers, test
						products, and understand local purchasing behaviours in
